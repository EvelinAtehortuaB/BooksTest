...
namespace BookStoreAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<BookStoreContext>(opt => opt.UseSqlServer(Configuration.GetConnectionString("SqlConnectionString"))).AddTransient<IDbContext, BookStoreContext>();
